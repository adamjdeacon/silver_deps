...
RUN dnf -y update
RUN dnf install -y  --enablerepo=powertools R gcc gcc-c++ libcurl-devel openssl-devel libxml2-devel libjpeg-turbo-devel glibc-locale-source glibc-langpack-en v8-devel chromium poppler-cpp-devel
